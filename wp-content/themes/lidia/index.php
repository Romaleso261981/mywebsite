        ...
        <div class="hero__container">
            <div class="hero__content content-hero">
                ...
                <div class="content-hero__text">
                    <p>
                        Embark on a literary journey like never before with our revolutionary library
                        application! Introducing a seamless experience that transcends traditional boundaries,
            ...
            <div class="hero__images images-hero">
                <a href="#" class="images-hero__item images-hero__item--01">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/hero/01.jpg" class="images-hero__image"
                        alt="Image">
                </a>
                <a href="#" class="images-hero__item images-hero__item--02">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/hero/02.jpg" class="images-hero__image"
                        alt="Image">
                </a>
                <a href="#" class="images-hero__item images-hero__item--03">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/hero/03.jpg" class="images-hero__image"
                        alt="Image">
                </a>
                <a href="#" class="images-hero__item images-hero__item--04">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/hero/04.jpg" class="images-hero__image"
                        alt="Image">
                </a>
            </div>
        </div>
            ...
            <div class="features__items">
                <div class="features__item">
                    <div class="features__icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/features/01.svg" alt="Image">
                    </div>
                ...
                <div class="features__item">
                    <div class="features__icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/features/02.svg" alt="Image">
                    </div>
                    <h4 class="features__title">Review book</h4>
                    <div class="features__text">
                        <p>Discover insightful critiques and share your thoughts on diverse literary
                            masterpieces effortlessly.</p>
                    </div>
                </div>
                <div class="features__item">
                    <div class="features__icon">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/features/03.svg" alt="Image">
                    </div>
                ...
                <article class="services__item">
                    <div class="services__content">
                        <div class="services__body">
                            <h4 class="services__title"><span>Rent</span> your favorite book fairly easy on
                                <span>Lidia</span>!
                            </h4>
                    ...
                    <div class="services__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/services/01.jpg"
                            class="services__picture" alt="Image">
                    </div>
                </article>
                <article class="services__item">
                    <div class="services__content">
                        <div class="services__body">
                            <h4 class="services__title">
                                Quick Book Rentals: <span>Dive</span> into <span>Reading</span> Instantly
                            </h4>
                            <div class="services__text">
                                <p>
                    ...
                    <div class="services__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/services/02.jpg"
                            class="services__picture" alt="Image">
                    </div>
                </article>
            </div>
            ...
            <div class="reviews__body">
                <div class="reviews__items">
                    <article class="reviews__item">
                        <a href="#" class="reviews__link-avatar">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/reviews/01.jpg"
                                class="reviews__avatar" alt="Image">
                        </a>
                        <div class="reviews__text">
                            <p>Engaging plot, vivid characters;
                                a captivating read that
                                lingers in your thoughts.</p>
                        </div>
                        <h4 class="reviews__title">
                            <a href="#" class="reviews__link-title">Ahmad Saugi</a>
                        </h4>
                        <div class="reviews__position">College Student</div>
                    </article>
                    <article class="reviews__item">
                        <a href="#" class="reviews__link-avatar">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/reviews/02.jpg"
                                class="reviews__avatar" alt="Image">
                        </a>
                        <div class="reviews__text">
                            <p>Engaging plot, vivid characters;
                    ...
                    <article class="reviews__item">
                        <a href="#" class="reviews__link-avatar">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/reviews/03.jpg"
                                class="reviews__avatar" alt="Image">
                        </a>
                        <div class="reviews__text">
                            <p>
                                Engaging plot, vivid characters;
                                a captivating read that
