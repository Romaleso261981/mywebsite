                ...
                <div class="hero__container">
                    ...
                    <div class="hero__images images-hero">
                        <a href="#" class="images-hero__item images-hero__item--01">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/hero/01.jpg"
                                class="images-hero__image" alt="Image">
                        </a>
                        <a href="#" class="images-hero__item images-hero__item--02">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/hero/02.jpg"
                                class="images-hero__image" alt="Image">
                        </a>
                        <a href="#" class="images-hero__item images-hero__item--03">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/hero/03.jpg"
                                class="images-hero__image" alt="Image">
                        </a>
                        <a href="#" class="images-hero__item images-hero__item--04">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/hero/04.jpg"
                                class="images-hero__image" alt="Image">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="footer__item">
                        ...
                        <div class="footer__social social">
                            <a href="#" class="social__item">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/social/twitter.svg"
                                    alt="Image">
                            </a>
                            <a href="#" class="social__item">
