            ...
            <article class="services__item">
              <div class="services__content">
                <div class="services__body">
                  <h4 class="services__title"><span>Rent</span> your favorite book fairly easy on <span>Lidia</span>!
                  </h4>
              ...
              <div class="services__image">
                <img src="<?php echo get_template_directory_uri(); ?>/img/services/01.jpg" class="services__picture"
                  alt="Image">
              </div>
            </article>
            <article class="services__item">
              ...
              <div class="services__image">
                <img src="<?php echo get_template_directory_uri(); ?>/img/services/02.jpg" class="services__picture"
                  alt="Image">
              </div>
            </article>
          </div>
            ...
            <div class="reviews__items">
              <article class="reviews__item">
                <a href="#" class="reviews__link-avatar">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/reviews/01.jpg" class="reviews__avatar"
                    alt="Image">
                </a>
              ...
              <article class="reviews__item">
                <a href="#" class="reviews__link-avatar">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/reviews/02.jpg" class="reviews__avatar"
                    alt="Image">
                </a>
                <div class="reviews__text">
                  <p>Engaging plot, vivid characters;
              ...
              <article class="reviews__item">
                <a href="#" class="reviews__link-avatar">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/reviews/03.jpg" class="reviews__avatar"
                    alt="Image">
                </a>
                <div class="reviews__text">
                  <p>
      ...
      <div class="footer__body">
        <div class="footer__container">
          <div class="footer__item">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/img/logo.png" alt="Image" class="footer__logo">
          </div>
          <div class="footer__item">
